    ...
    try {
      const batch = await this.prisma.uploadBatch.create({
        data: {
          ...
          processingStatusIpd: (data as any).processingStatusIpd || BatchProcessingStatus.PENDING,
          processingStatusOpd: (data as any).processingStatusOpd || BatchProcessingStatus.PENDING,
          exportStatusIpd: (data as any).exportStatusIpd || ExportStatus.NOT_EXPORTED,
          exportStatusOpd: (data as any).exportStatusOpd || ExportStatus.NOT_EXPORTED,
