      ...
      <div className='min-h-screen bg-gray-50'>
        ...
        <div className='max-w-7xl mx-auto py-6 sm:px-6 lg:px-8'>
          <div className='px-4 py-6 sm:px-0'>
                ...
                <div className='p-5'>
                  <div className='flex items-center'>
                    ...
                    <div className='ml-5 w-0 flex-1'>
                      <dl>
                        <dt className='text-sm font-medium text-gray-500 truncate'>บทบาท</dt>
              ...
              <div className='bg-white overflow-hidden shadow rounded-lg'>
                <div className='p-5'>
                  <div className='flex items-center'>
                    ...
                    <div className='ml-5 w-0 flex-1'>
                      <dl>
                        <dt className='text-sm font-medium text-gray-500 truncate'>สถานะระบบ</dt>
                        <dd className='text-lg font-medium text-gray-900'>ออนไลน์</dd>
                      </dl>
                    </div>
                  </div>
                </div>
            ...
            {/* เมนูด่วน */}
            <div className='mt-8'>
              <h2 className='text-xl font-semibold text-gray-900 mb-4'>เมนูด่วน</h2>
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                ...
                >
                  ...
                  <h3 className='text-lg font-medium text-gray-900'>ช่วยเหลือ</h3>
