...
import { ChartBarIcon, UserIcon, Cog6ToothIcon } from '@/components/ui/Icons';
        ...
        <Card className='shadow-lg bg-default'>
          <CardHeader className='flex items-center space-x-3'>
            ...
            <div>
              ...
              <p className='text-sm text-default-600'>ข้อมูลการใช้งาน</p>
            </div>
          </CardHeader>
          <CardBody>
            <div className='space-y-2'>
        ...
        <Card className='shadow-lg bg-default'>
          <CardHeader className='flex items-center space-x-3'>
            ...
            <div>
              ...
              <p className='text-sm text-default-600'>จัดการระบบ</p>
            </div>
          </CardHeader>
          <CardBody>
            <div className='space-y-2'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div>
                ...
                <div className='space-y-1 text-sm text-default-600'>
                  ...
                  <p>บทบาท: {session?.user?.role || 'ไม่ระบุ'}</p>
                </div>
              </div>
              <div>
                <h3 className='font-medium text-foreground mb-2'>
                ...
                <div className='space-y-1 text-sm text-default-600'>
                  <p>สถานะ: <span className='text-success-600'>ออนไลน์</span></p>
                  <p>การเชื่อมต่อ: <span className='text-success-600'>ปกติ</span></p>
                  <p>สิทธิ์การเข้าถึง: <span className='text-success-600'>อนุญาต</span></p>
                </div>
              </div>
            </div>
          </CardBody>
