      ...
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
          {stats.map((stat) => (
            <Card
              key={stat.id}
              className='hover:shadow-lg bg-background/90 backdrop-blur-lg border border-default-200 dark:border-default-700'
            >
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
          ...
          <Card className='bg-background/90 backdrop-blur-lg border border-default-200 dark:border-default-700'>
            <CardHeader>
              <h3 className='text-xl font-bold text-foreground'>สถานะระบบ</h3>
            </CardHeader>
            <CardBody>
