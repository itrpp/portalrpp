...
export default function ProfileClient({ initialProfile }: ProfileClientProps) {
  ...
  const handleOrgSelectChange =
    ...
    (key: string | number | null) => {
      ...
      setFormData((prev) => {
        const next: ProfileEditableFields = {
          ...prev,
          [field]: value,
        };
  ...
  return (
    <div className="space-y-6">
      {/* Profile Header Card */}
      <Card className="border border-default-200 dark:border-default-600 shadow-lg bg-linear-to-br from-primary-50 to-default-50 dark:from-primary-900/20 dark:to-default-900/20">
