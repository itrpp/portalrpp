...
import { ProcessingStatus, ExportStatus } from '@/types';
            ...
            <CardHeader>
                <div className="flex items-center justify-between w-full">
                    <div className="flex items-center space-x-2">
                        ...
                        <h2 className="text-xl font-semibold">จัดการข้อมูล 16 แฟ้ม IPD</h2>
                    </div>
                    <div className="flex items-center space-x-4">
                        <div className="text-sm text-default-600">
                            IPD Batches ทั้งหมด {uploadBatches.length} รายการ
                            {lastUpdated && (
                                <span className="ml-2">
            ...
            <CardBody>
                {isLoading ? (
                    ...
                    <div className="flex flex-col justify-center items-center py-8 space-y-2">
                        ...
                        <div className="text-default-600">ไม่พบข้อมูล IPD Batches</div>
                        <div className="text-sm text-default-400">กรุณาอัปโหลดไฟล์ IPD (16 แฟ้ม) ก่อนเพื่อแสดงข้อมูลที่นี่</div>
                        <div className="text-xs text-default-300">หน้านี้แสดงเฉพาะข้อมูล IPD Files เท่านั้น</div>
                    </div>
                ) : (
                    <Table aria-label="IPD Batches Table" className="w-full">
                        <TableHeader>
                                ...
                                <TableRow key={batch.id}>
                                    ...
                                    <TableCell className="whitespace-nowrap">
                                        <span className="text-xs font-mono">
                                            {batch.totalRecords?.toLocaleString() || '0'}
                                        </span>
                                    </TableCell>
                                    <TableCell className="whitespace-nowrap">
