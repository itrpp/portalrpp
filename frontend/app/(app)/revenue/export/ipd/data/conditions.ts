...
export const conditionsData = [
  {
    ...
    purpose:
      "เตรียมไฟล์ ADP สำหรับระบบ IPD ตามมาตรฐาน e-Claim ของ สปสช. โดยเพิ่ม field SP_ITEM เพื่อรองรับข้อมูลการจำแนกรายการพิเศษ",
  },
  {
    file: "DRU",
    title: "เพิ่ม field SP_ITEM สำหรับระบบ IPD ตามมาตรฐาน e-Claim",
    ...
    purpose:
      "เตรียมไฟล์ยาสำหรับระบบ IPD ตามมาตรฐาน e-Claim ของ สปสช. โดยรักษาความสมบูรณ์ของข้อมูลต้นฉบับและเพิ่ม field SP_ITEM",
  },
  {
    file: "OTHER",
    ...
    purpose:
      "ส่งออกไฟล์ 14 แฟ้มอื่นๆ (นอกเหนือจาก ADP และ DRU) ไปยังระบบ IPD ตามมาตรฐาน e-Claim โดยรักษาข้อมูลต้นฉบับไว้ครบถ้วน",
  },
];
...
export const problemSolutions = [
  {
    problem:
      "ไฟล์ ADP และ DRU ไม่มี field SP_ITEM สำหรับระบบ IPD ตามมาตรฐาน e-Claim",
    solution:
      "เพิ่ม field SP_ITEM (Character, length=2) ต่อท้ายสุดโดยไม่เปลี่ยนแปลงข้อมูลต้นฉบับ และกำหนดค่าเริ่มต้นเป็น empty string",
    files: ["ADP", "DRU"],
  },
  {
    problem: "ข้อมูลภาษาไทยในไฟล์ DRU เสียหายเมื่อแปลงรูปแบบหรือ encoding",
    solution:
      "ใช้ Buffer copy เพื่อรักษาข้อมูลภาษาไทยและรูปแบบวันที่ไว้ตามต้นฉบับ รวมถึงรักษา TIS-620 encoding",
    files: ["DRU"],
  },
  {
    problem:
      "รูปแบบวันที่ในไฟล์ DRU เปลี่ยนไปจากต้นฉบับ ทำให้ข้อมูล DATE_SERV ผิดพลาด",
    solution:
      "รักษารูปแบบวันที่ต้นฉบับโดยไม่มีการแปลงใดๆ และใช้ Buffer copy สำหรับ field DATE_SERV",
    files: ["DRU"],
  },
  {
    problem:
      "ไฟล์ 14 แฟ้มอื่นๆ (นอกเหนือจาก ADP และ DRU) ไม่สามารถส่งออกไปยังระบบ IPD ได้ตามมาตรฐาน",
    solution:
      'Copy ไฟล์ต้นฉบับทั้ง 14 แฟ้มโดยไม่มีการเปลี่ยนแปลงใดๆ และเพิ่ม suffix "_IPD.dbf"',
    files: ["OTHER"],
  },
  {
    problem: "การตรวจสอบ field SP_ITEM ซ้ำซ้อนในไฟล์ที่มี field นี้อยู่แล้ว",
    solution:
      "ตรวจสอบการมีอยู่ของ field SP_ITEM ก่อนการประมวลผล หากมีแล้วให้รักษาค่าเดิมไว้",
    files: ["ADP", "DRU"],
  },
  {
    problem:
      "ข้อมูลใน field DIDNAME และ UNIT ของไฟล์ DRU เสียหายจากการประมวลผล",
    solution:
      "ใช้ Buffer copy โดยตรงสำหรับทุก field ในไฟล์ DRU เพื่อรักษาข้อมูลต้นฉบับไว้ทุกประการ",
    files: ["DRU"],
  },
];
