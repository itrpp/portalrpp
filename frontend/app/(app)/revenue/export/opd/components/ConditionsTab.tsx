...
import { CogIcon, DocumentTextIcon } from "@/components/ui/icons";

export const ConditionsTab: React.FC = () => {
  // รวมเงื่อนไขทั้งหมดเข้าด้วยกัน
  const allConditions = [...conditionsData];
            ...
            <CardHeader className="pb-2">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="font-medium text-sm">
                  ไฟล์ {condition.file}: {condition.title}
                </h3>
              </div>
            </CardHeader>
            <CardBody className="pt-0 space-y-3">
                ...
                <ul className="ml-6 space-y-1">
                  {condition.conditions.map((cond, idx) => (
                    ...
                    >
                      ...
                      <span className="text-default-700 leading-relaxed">
                        {cond}
                      </span>
                    </li>
                  ))}
              ...
              <div className="space-y-1">
                <div className="flex items-center space-x-2">
                  ...
                  <h4 className="font-medium text-success text-sm">
                    วัตถุประสงค์:
                  </h4>
