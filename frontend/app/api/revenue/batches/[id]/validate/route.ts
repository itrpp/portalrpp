...
// ตรวจสอบไฟล์รายได้ตาม ID โดยส่งต่อคำขอไปยัง API Gateway
export async function POST(
  ...
  try {
    ...
    // หมายเหตุ: เส้นทางฝั่ง client เรียก /api/revenue/batches/validate/:id
    // จึงต้องส่งต่อไปที่ API Gateway ในรูปแบบเดียวกัน
    const endpoint = `${baseUrl}/api-gateway/revenue/files/${encodeURIComponent(_id)}/validate/`;
