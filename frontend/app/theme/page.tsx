        ...
        <CardBody className="space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-primary-50 border border-primary-200 rounded-lg">
                <h5 className="font-medium text-primary-800 mb-2">Primary Card</h5>
                <p className="text-sm text-primary-600">
                  การ์ดที่มีพื้นหลังสีฟ้าอ่อน
                </p>
              </div>
              <div className="p-4 bg-secondary-50 border border-secondary-200 rounded-lg">
                <h5 className="font-medium text-secondary-800 mb-2">Secondary Card</h5>
          ...
          <div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-primary-500">ข้อความสีฟ้าอ่อน (Primary Light)</p>
              <p className="text-secondary-600">ข้อความสีเขียว (Secondary)</p>
              <p className="text-secondary-500">ข้อความสีเขียวอ่อน (Secondary Light)</p>
            </div>
          </div>
        </CardBody>
      </Card>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="p-3 bg-primary-500 text-white rounded-lg">
                  ...
                  <p className="text-sm opacity-90">Buttons, Links, Focus States</p>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="p-3 bg-secondary-500 text-white rounded-lg">
                  ...
                  <p className="text-sm opacity-90">Success States, Confirmations</p>
                </div>
                <div className="p-3 bg-secondary-400 text-white rounded-lg">
                  <span className="font-medium">Secondary 400 (Light)</span>
                  <p className="text-sm opacity-90">Status Indicators, Accents</p>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="p-3 bg-warning-500 text-white rounded-lg">
                  ...
                  <p className="text-sm opacity-90">Alert Messages, Notifications</p>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="p-3 bg-danger-500 text-white rounded-lg">
                  ...
                  <p className="text-sm opacity-90">Error Messages, Delete Actions</p>
                </div>
                <div className="p-3 bg-danger-400 text-white rounded-lg">
                  <span className="font-medium">Danger 400 (Light)</span>
                  <p className="text-sm opacity-90">Critical Status, Validation Errors</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                <div className="p-3 border border-divider rounded-lg">
                  <p className="text-primary-500 font-medium">ข้อความสีฟ้า (Primary)</p>
                  <p className="text-primary-400 text-sm">ข้อความสีฟ้าอ่อน (Primary Light)</p>
                  <p className="text-secondary-500 font-medium">ข้อความสีเขียว (Secondary)</p>
                  <p className="text-secondary-400 text-sm">ข้อความสีเขียวอ่อน (Secondary Light)</p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="p-3 border border-divider rounded-lg">
                  <p className="text-warning-500 font-medium">ข้อความสีส้ม (Warning)</p>
                  <p className="text-warning-400 text-sm">ข้อความสีส้มอ่อน (Warning Light)</p>
                  <p className="text-danger-500 font-medium">ข้อความสีแดง (Danger)</p>
                  <p className="text-danger-400 text-sm">ข้อความสีแดงอ่อน (Danger Light)</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <CardBody className="space-y-6">
          ...
          <div className="border-t border-divider pt-4">
            ...
            <div className="text-sm text-default-600 space-y-2">
              <p>
                • ใช้ contrast ratio ที่เหมาะสม (WCAG AA: 4.5:1 สำหรับ text ขนาดปกติ)
              </p>
              <p>
                • หลีกเลี่ยงการใช้สีเป็นข้อมูลเดียวในการสื่อสาร
              </p>
              <p>
                • ใช้สีร่วมกับ icons หรือ text เพื่อความชัดเจน
              </p>
              <p>
                • รองรับ dark mode และ light mode
              </p>
              <p>
                • ใช้ warning colors สำหรับการแจ้งเตือน และ danger colors สำหรับข้อผิดพลาด
              </p>
            </div>
          </div>
        </CardBody>
